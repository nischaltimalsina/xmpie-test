        ...
        <div id="main">
            <section id="one" className="tiles">
                ...
                <article style={{ backgroundImage: `url(${xmp.r['photo1']})` }}>
                    ...
                    <header className="major">
                        <h3>
                            <a href="content.html" className="link">
                                Excitement
                            </a>
                        </h3>
            ...
            <section id="two" className={xmp.r.backgroundColor}>
                <div className="inner">
                    ...
                    <p>
                        At Round Travel we personalize the travel experience by offering the best
                        destinations, tours and itineraries based on your preferences!
                    </p>
